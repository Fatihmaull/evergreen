...
export function render(ctx) {
  const exitRows = [
    ...
    .join('');
  return `<section class="feature flip">
    <div class="site-wrap feature-grid">
      <div class="feature-text">
        <p class="eyebrow">Usage and flags</p>
        <h2>The tool describing itself</h2>
        <p>Printed by <span class="mono">evergreen scan --help</span>, not transcribed from it.</p>
      ...
      <div class="feature-art"><div class="terminal">${esc(ctx.cli.help)}</div></div>
    </div>
  </section>
  <section class="prose">
    <div class="site-wrap">
  ...
  <section class="prose">
    <div class="site-wrap">
      <h2>Run it before it is published</h2>
      <p>
