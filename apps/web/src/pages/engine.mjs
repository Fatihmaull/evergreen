...
export function render() {
  return `<section class="card card-pad stack">
    ...
    <p class="muted">
      Declared: every 15 minutes. <strong>Measured on 2026-09-14</strong>, on two independent workflows with
      different creation dates and different windows — which is what makes this a property of the platform
      rather than of one file. These are that day's figures, frozen with their record; the delivery rate has
      moved between measurements before, and <span class="mono">pnpm measure:cadence</span> re-measures it.
    </p>
