...
**Separate review finding (2026-09-07):** `.prettierignore` at merged `5509c44` retains conflict markers on lines 24–31. The broad `docs/evidence/` exclusion is still effective and the current checks pass. No formatter configuration change is included in this scheduler evidence work; flag the cleanup for the next reviewed scope.
