...
`node scripts/build-proof-runtime.mjs /tmp/evergreen-w3-save-runtime-UNIQUE`.
...
`w3-save-`, absolute `configPath`, SHA-256 `configSha256`, absolute `attemptFile`
