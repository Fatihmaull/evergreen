...
- Full `pnpm check` exit 0: **452 Vitest + 44 Node = 496 tests**. [Original output](pnpm-check.txt). Coverage 94.16% statements / 88.94% branches / 93.89% functions / 95.84% lines.
