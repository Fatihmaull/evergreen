...
| [ADR-003](ADR-003-toolchain-hosting-persistence.md) | Toolchain, hosting, scheduler, and persistence | Toolchain and Actions scheduler decided; PostgreSQL proposed after local spike; hosted provider and dashboard hosting open |
