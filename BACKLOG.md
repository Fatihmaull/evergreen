...
- [~] **W1-D6-04** (R) Decide and document persistence/atomic locking in ADR-003. **2026-09-08 started:** claimed from the explicit [handoff #39](https://github.com/Fatihmaull/evergreen/issues/39#issuecomment-5579179171), tracked in [Issue #30](https://github.com/Fatihmaull/evergreen/issues/30). Primary branch: `chore/W1-D6-04-persistence-spike`. Evaluate GitHub Actions + PostgreSQL, record the Workers compatibility outcome, and prove contention/recovery with a bounded database spike. Hosted provider selection is under review; no production engine or live bump in this task.
