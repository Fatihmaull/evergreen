...
- [ ] **W1-D4-09** (S) **Recurring drift check.** Twice weekly until Sep 20, run `check-decay-drift.py` and record the output in `docs/STATUS.md`. A set-and-forget calibration is how a two-hour drift becomes a missed proof.
