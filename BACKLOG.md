...
- [~] **W1-D5-04** (R) Email provider account + a test email successfully sent from code. **2026-09-08 follow-up in progress:** the 2026-09-07 Resend acceptance and confirmed inbox receipt were accepted in [Issue #37](https://github.com/Fatihmaull/evergreen/issues/37#issuecomment-5573281589); no second send is needed. Integrate the preserved local probe, nine offline tests and existing evidence on `chore/W1-D5-04-email-follow-up`, based on main `cdbbb77` (PRs #36/#38). Preserve the shared-types checks. Retire the probe when `EmailChannel` lands at `W3-D17-01`; engine notifications remain W3.
