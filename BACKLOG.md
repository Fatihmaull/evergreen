...
- [~] **W1-D6-02** (R) Write `docs/ARCHITECTURE.md` data-flow section against those types (RPC → core → {CLI, engine, dashboard}). **2026-09-08:** documentation work started on `docs/W1-D6-02-architecture-flow`, tracked in [#32](https://github.com/Fatihmaull/evergreen/issues/32). Current scan flow, planned engine flow, shared-entry example and W3/W4 persistence boundaries; no runtime implementation.
